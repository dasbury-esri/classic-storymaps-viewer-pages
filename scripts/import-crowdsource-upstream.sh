...
UPSTREAM_REPO="${UPSTREAM_REPO:-storymap-crowdsource}"
DESTINATION="${DESTINATION:-runtimes/crowdsource/upstream}"
...
echo "Crowdsource upstream import complete at $DEST_PATH"
